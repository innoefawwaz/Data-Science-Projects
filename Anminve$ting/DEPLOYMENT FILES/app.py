...
# ---- Setting up the questionnaire Form ----
    ...
    # ---- SHOWING MUTUAL FUNDS OPTIONS----
        def money_market():
                ...
                df_1 = pd.read_csv('MoneyMarketFund/MNC Dana Lancar_HL.csv')
                df_high = pd.read_csv('MoneyMarketFund/MNC High Forecast.csv')
                df_low = pd.read_csv('MoneyMarketFund/MNC Low Forecast.csv')
                def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def fixed_income_1():
                        # ---- SHOWING THE FULL GRAPH ----
                df_2 = pd.read_csv('FixedIncomeFund/Ashmore Dana Obligasi Nusantara/Ashmore Dana Obligasi Nusantara_HL.csv')
                df_high = pd.read_csv('FixedIncomeFund/Ashmore Dana Obligasi Nusantara/ADON High Forecast.csv')
                df_low = pd.read_csv('FixedIncomeFund/Ashmore Dana Obligasi Nusantara/ADON Low Forecast.csv')
        ...
        def fixed_income_2():
        # ---- SHOWING THE FULL GRAPH ----
                df_3 = pd.read_csv('FixedIncomeFund/Schroder Dana Mantap II/Schroder Dana Mantap II_HL.csv')
                df_high = pd.read_csv('FixedIncomeFund/Schroder Dana Mantap II/SDM High Forecast.csv')
                df_low = pd.read_csv('FixedIncomeFund/Schroder Dana Mantap II/SDM Low Forecast.csv')
                def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def mixed_fund():
            df_4 = pd.read_csv('BalancedFund/Schroder Dana Terpadu II.csv')
            df_high = pd.read_csv('BalancedFund/SDT High Forecast.csv')
            df_low = pd.read_csv('BalancedFund/SDT Low Forecast.csv')
            def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def stock1():
            df_5 = pd.read_csv('EquityFund/Ashmore_Dana_Ekuitas_Nusantara/Ashmore_Dana_Ekuitas_Nusantara_HL.csv')
            df_high = pd.read_csv('EquityFund/Ashmore_Dana_Ekuitas_Nusantara/ADEN High Forecast.csv')
            df_low = pd.read_csv('EquityFund/Ashmore_Dana_Ekuitas_Nusantara/ADEN Low Forecast.csv')
            def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def stock2():
            df_6 = pd.read_csv('EquityFund/Ashmore_Dana_Progresif_Nusantara/Ashmore Dana Progresif Nusantara_HL.csv')
            df_high = pd.read_csv('EquityFund/Ashmore_Dana_Progresif_Nusantara/ADPN High Forecast.csv')
            df_low = pd.read_csv('EquityFund/Ashmore_Dana_Progresif_Nusantara/ADPN Low Forecast.csv')
            def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def stock3():
            df_7 = pd.read_csv('EquityFund/Schroder_Dana_Prestasi/Schroder Dana Prestasi_HL.csv')
            df_high = pd.read_csv('EquityFund/Schroder_Dana_Prestasi/SDP High Forecast.csv')
            df_low = pd.read_csv('EquityFund/Schroder_Dana_Prestasi/SDP Low Forecast.csv')
            def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
        ...
        def stock4():
            df_8 = pd.read_csv('EquityFund/Schroder_Dana_Prestasi_Plus/Schroder Dana Prestasi Plus_HL.csv')
            df_high = pd.read_csv('EquityFund/Schroder_Dana_Prestasi_Plus/SDPP High Forecast.csv')
            df_low = pd.read_csv('EquityFund/Schroder_Dana_Prestasi_Plus/SDPP Low Forecast.csv')
            def plot_raw_data():
                    fig = go.Figure(
                            data = [
                            go.Scatter(
...
if page_nav == "What is Mutual Funds?":
    st.markdown("""
            # A Brief Explanation About Mutual Funds
    """)
    st.markdown("""
